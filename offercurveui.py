...
# === Left column: Generator + view mode (and downloads later)
with left_col:
...
if not sample_indices:
    ...
    with left_col:
        ...
        st.download_button("Download Current Generator Predictions", data=excel_single, file_name=f"{generator}_forecast.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")

        excel_all = convert_all_predictions_to_excel(all_preds, Y, resource_names, timestamps)
        st.download_button("Download All Generators Forecasts", data=excel_all, file_name="all_forecasts.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
